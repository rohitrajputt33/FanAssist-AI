...
export default function Home() {
  ...
  // Efficiency: Use useCallback to prevent unnecessary re-renders of child components
  const handleIncidentReported = useCallback((data: any) => {
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <header className="mb-12 max-w-2xl">
          ...
          <p className="text-slate-400 leading-relaxed">
            ...
            The LLM autonomously parses the intent, assigns severity, recommends dispatch units, and populates the Security Command Center on the right.
          </p>
        </header>
